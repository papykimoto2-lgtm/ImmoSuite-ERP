-- ═══════════════════════════════════════════════════════════════════════════
-- RLS portail — RÉFÉRENCE, NON APPLIQUÉE PAR scripts/provision-client.mjs.
--
-- Rédigée par l'équipe (trouvée dans le fork MENCO-HOLDING, portal_rls.sql),
-- reprise ici telle quelle pour servir de base à un futur chantier de
-- durcissement RLS. L'app STAFF actuelle (ImmoSuite/Zahara/MENCO) tourne
-- avec la clé anon en accès complet ; activer ce script coupe cet accès
-- et suppose que l'app STAFF bascule sur un rôle authentifié dédié ou des
-- Edge Functions service_role AVANT activation en prod. Ne pas exécuter
-- sans revue et plan de bascule.
-- ═══════════════════════════════════════════════════════════════════════════
